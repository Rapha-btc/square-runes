...
3. **Technical Verification**: Clarity can create a trustless map between multi-sig (runes receiver) and tx-sender's pubkey signer (user sends Runes to a multi-sig of which their stacks' pubkey is a signer)
